...
function FeatureCard({ feature, index }: { feature: typeof features[0]; index: number }) {
  return (
    ...
    >
      <div className="absolute inset-0 bg-linear-to-br opacity-0 group-hover:opacity-20 rounded-3xl transition-opacity duration-500"
           style={{ backgroundImage: `linear-gradient(to bottom right, var(--tw-gradient-stops))` }} 
      />
      <div className="relative p-8 bg-white/3 backdrop-blur-sm border border-white/10 rounded-3xl hover:border-indigo-500/30 transition-all duration-500">
        {/* Icon */}
        ...
        {/* Content */}
        <div className="space-y-2 p-4 mb-4">
    ...
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute inset-0 bg-linear-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10 rounded-3xl blur-3xl" />
          <div className="relative p-8 md:p-12 bg-white/2 backdrop-blur-sm border border-white/10 rounded-3xl">
